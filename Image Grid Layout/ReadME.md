...
[Live Demo](https://anaid-ariwany.github.io/Roadmap.sh-Frontend-Projects/Image%20Grid%20Layout/)
...
## Desired Outcome
![alt text](assets/desiredOutcome.png)
...
- **_Grid Structure:_** Understand the fundamentals of CSS Grid, including defining grid containers, rows, columns, and how to place items within the grid.

- **_Responsive Design:_** Learn how to make the grid layout responsive so that it adapts to different screen sizes. This might involve changing the number of columns or the layout of the images based on the viewport width.

- **_Alignment and Spacing:_** Explore how to align grid items and manage spacing between them to achieve a clean and visually appealing layout.
